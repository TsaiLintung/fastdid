estimate_did_rc <- function(dt_did, covnames, control_type,
  ...
  dt_did[, att_treat_post := treat_ipw_weight*(post.y-or_delta_post)] #minus the OR adjust
  dt_did[, att_cont_post := cont_ipw_weight*(post.y-or_delta_post)]
  ...
  # influence from did
  inf_cont_did_post <- dt_did[, att_cont_post - cont_ipw_weight*inpost*weighted_cont_post]
  inf_treat_did_post <-  dt_did[, (att_treat_post - treat_ipw_weight*inpost*weighted_treat_post)]
  inf_cont_did_pre <- dt_did[, att_cont_pre - cont_ipw_weight*inpre*weighted_cont_pre]
  inf_treat_did_pre <-  dt_did[, (att_treat_pre -  treat_ipw_weight*inpre*weighted_treat_pre)]
