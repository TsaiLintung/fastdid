...
```
Diagnostics can be obtained by using `time >= G2` as outcome. Since we set the effect of the confounding event at 10 constantly, it is clear that the bias of the default estimator is roughly 10 times the diagnostics.
